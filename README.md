...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-infeppy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-infeppy.containers.anotherwebservice.com/
...
```
git clone git@github.com:deepakgohil9/container-infeppy.git
cd container-infeppy
```
...
```
docker attach container-infeppy
```
